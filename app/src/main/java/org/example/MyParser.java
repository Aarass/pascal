...
/** CUP v0.10k generated parser.
  * @version Sat Aug 16 01:59:12 CEST 2025
  */
public class MyParser extends java_cup.runtime.lr_parser {
  ...
  protected static final short[][] _action_table = 
    ...
    "\000\010\005\ufffa\011\ufffa\012\ufffa\001\002\000\006\005" +
    ...
    "\000\006\016\ufffe\023\ufffe\001\002\000\010\005\ufffb\011" +
      ...
      switch (CUP$MyParser$act_num)
        {
          ...
          case 28: // IfNar ::= IF Izraz THEN Naredba ELSE Naredba 
            {
              Object RESULT = null;
		 System.out.println("Pronasao IfNar"); 
          ...
          case 27: // Fizraz ::= LEFTPAR Izraz RIGHTPAR 
            {
              Object RESULT = null;
		 System.out.println("Pronasao Fizraz"); 
          ...
          case 24: // Pizraz ::= Fizraz 
            {
              Object RESULT = null;
		 System.out.println("Pronasao Pizraz"); 
          ...
          case 22: // Izraz ::= Pizraz 
            {
              Object RESULT = null;
		 System.out.println("Pronasao Izraz"); 
          ...
          case 20: // Dodela ::= ID ASSIGN Izraz 
            {
              Object RESULT = null;
		 System.out.println("Pronasao Dodela"); 
          ...
          case 19: // Izlaz ::= WRITE LEFTPAR Izraz RIGHTPAR 
            {
              Object RESULT = null;
		 System.out.println("Pronasao Izlaz"); 
          ...
          case 18: // Ulaz ::= READ LEFTPAR ID RIGHTPAR 
            {
              Object RESULT = null;
		 System.out.println("Pronasao Ulaz"); 
          ...
          case 17: // Naredba ::= IfNar 
            {
              Object RESULT = null;
		 System.out.println("Pronasao Naredba"); 
          ...
          case 12: // NizNar ::= Naredba 
            {
              Object RESULT = null;
		 System.out.println("Pronasao NizNar"); 
          ...
          case 10: // Blok ::= BEGIN NizNar END 
            {
              Object RESULT = null;
		 System.out.println("Pronasao Blok"); 
          ...
          case 9: // Tip ::= CHAR 
            {
              Object RESULT = null;
		 System.out.println("Pronasao Tip"); 
          ...
          case 7: // NizImena ::= ID 
            {
              Object RESULT = null;
		 System.out.println("Pronasao NizImena"); 
          ...
          case 5: // Deklaracija ::= NizImena COLON Tip 
            {
              Object RESULT = null;
		 System.out.println("Pronasao Deklaracija"); 
          ...
          case 4: // NizDekl ::= Deklaracija 
            {
              Object RESULT = null;
		 System.out.println("Pronasao NizDekl"); 
          ...
          case 2: // DeklProm ::= VAR NizDekl 
            {
              Object RESULT = null;
		 System.out.println("Pronasao DeklProm"); 
		...
		RESULT = start_val;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 0: // Program ::= PROGRAM LEFTPAR NizImena LEFTPAR SEMI DeklProm Blok DOT 
            {
              Object RESULT = null;
		 System.out.println("Pronasao Program"); 
